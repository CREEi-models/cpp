...
module cpp
	...
	parameter (nccpyears = 2130 - 1966 + 1, cppfirstyear=1966, cpplastyear = 2130)
	integer ncppbyear, cpplastbyear, cppfirstbyear
	parameter (nccpbyear= 2065 - 1904 + 1, cpplastbyear = 2065, cppfirstbyear = 1904 )
...
type tp_cpphist
	...
	subroutine getaape(aape,byear,year,age,cpphist, qcdummy,id)
		...
		double precision::upe(:)  ! Unadjusted Pensionable Earning
		double precision::ape(:) ! Adjusted Pensionable Earning
